...
I came across this data set from the Florida Department of Education in March. In Florida schol districts are organized by county and that this was an opportunity to improve my mappig skills.
...
The first step is extract state shapes from the map data. 
...
The next step is to extract county shapes from Florida
...
I used this [website](http://eriqande.github.io/rep-res-web/lectures/making-maps-with-R.html) by Eric C. Anders to help fine tune the maps of Florida. 
...
In this chunk, I changed the name of the variable district_name to match the county data set. Case matters and the school district data set needed to be made lower in preperation of joining the data sets.  
...
Not all of the district_name and map data perfectly match. This is code will fix that. You will see that anti-join is easy way to test. 
